...
public class MapUtils {
    public static void main(String[] args) {
        try {
            // 1、根据地址获取经纬度
            Map<String, String> lonAndLat = getLonAndLat("湖北省随州市曾都区吾悦广场", "718aa8c60f6e5b904cba8ab07e31c62e");
            System.out.println("转换后经纬度为：" + lonAndLat);
            // 2、根据经纬度获取地址
            String formattedAddress = getAMapByLngAndLat("113.401247", "31.690330", "718aa8c60f6e5b904cba8ab07e31c62e");
