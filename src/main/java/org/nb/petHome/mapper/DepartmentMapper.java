...
public interface DepartmentMapper {
     ...
     * @param d Department
     */
    @Insert("insert into t_department(sn,name,manager_id,parent_id,state) values(#{sn},#{name},#{manager.id},#{parent.id},#{state})")
    ...
    @Update("update t_department set " +
            ...
            "parent_id=#{parent.id},state=#{state} where id=#{id}")
